...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/cr/v1alpha1.Profile":         schema_pkg_apis_cr_v1alpha1_Profile(ref),
		"./pkg/apis/cr/v1alpha1.ProfileSpec":     schema_pkg_apis_cr_v1alpha1_ProfileSpec(ref),
		"./pkg/apis/cr/v1alpha1.ProfileStatus":   schema_pkg_apis_cr_v1alpha1_ProfileStatus(ref),
	}
}
...
func schema_pkg_apis_cr_v1alpha1_Profile(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/cr/v1alpha1.ProfileSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/cr/v1alpha1.ProfileStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/cr/v1alpha1.ProfileSpec", "./pkg/apis/cr/v1alpha1.ProfileStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
